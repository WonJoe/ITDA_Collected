...
const LocationServicePolicy = () => {
    return (
        <div className='footer-desc' style={{fontSize:'16px',lineHeight:1.75, padding:'24px 40px'}}>
            <h1>위치정보 이용약관</h1>
                <h2>제 1 조 (목적)</h2>
                    <p>본 약관은 주식회사 ITDA(이하 "회사")가 제공하는 사물위치정보 및 위치기반 서비스(이하, 위치정보 서비스)에 대해 회사와 서비스를 이용하는 이용자간의 권리·의무 및 책임사항, 기타 필요한 사항 규정을 목적으로 합니다.</p>
                <h2>제 2 조 (이용약관의 효력 및 변경)</h2>
                    <table>
                        <tbody>
                        <tr>
                            <td className='number-part'>
                                ①
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                약관이 변경되는 경우 회사는 변경사항을 그 적용일자 최소 15일 전에 회사의 홈페이지 또는 서비스 공지사항 등(이하, 홈페이지 등)을 통해 공지합니다. 다만, 개정되는 내용이 이용자 권리의 중대한 변경을 발생시키는 경우 적용일 최소 30일 전에 이메일(이메일주소가 없는 경우 서비스 내 전자쪽지 발송, 서비스 내 알림 메시지를 띄우는 등의 별도의 전자적 수단) 발송 또는 등록한 휴대폰번호로 ITDA톡 메시지 또는 문자메시지를 발송하는 방법 등으로 개별적으로 고지합니다.
                            </td>
                        </tr>
                        <tr>
                            <td className='number-part'>
                ...
                <h2>제 4 조 (서비스의 내용)</h2>
                    <p>회사는 위치정보사업자로부터 수집한 이용자의 위치정보 또는 직접 수집한 사물위치정보를 이용하여 아래와 같은 위치정보 서비스를 제공합니다.</p>
                    <table>
                        <tbody>
                        <tr>
                            <td className='number-part'>
                ...
                <h2>제 5 조 (서비스 이용요금)</h2>
                    <p>회사가 제공하는 위치정보 서비스는 무료입니다.<br/>단, 무선 서비스 이용 시 발생하는 데이터 통신료는 별도이며, 이용자가 가입한 각 이동통신사의 정책에 따릅니다.</p>
                <h2>제 6 조 (서비스의 변경・제한・중지)</h2>
                    <table>
                        <tbody>
                        <tr>
                            <td className='number-part'>
                ...
                <h2>제 8 조 (개인위치정보의 보유 목적 및 보유기간)</h2>
                    <p>
                ...
                <h2>제 12 조 (손해배상)</h2>
                    <p>회사의 위치정보의 보호 및 이용 등에 관한 법률 제15조 및 26조의 규정을 위반한 행위로 인해 손해를 입은 경우 이용자는 회사에 손해배상을 청구할 수 있습니다. 회사는 고의, 과실이 없음을 입증하지 못하는 경우 책임을 면할 수 없습니다.</p>
                <h2>제 13 조 (면책)</h2>
                    <table>
                        <tbody>
                        <tr>
                            <td className='number-part'>①</td><td>회사는 다음 각 호의 경우로 위치기반서비스를 제공할 수 없는 경우 이로 인하여 이용자에게 발생한 손해에 대해서는 책임을 부담하지 않습니다.</td>
                        </tr>
                        <tr>
                            <td colSpan={3}>
                                <div className='number-p'>
                        ...
                        <tr>
                            <td className='number-part'>②</td><td>회사는 위치기반서비스 및 위치기반서비스에 게재된 정보, 자료, 사실의 신뢰도, 정확성 등에 대해서는 보증을 하지 않으며 이로 인해 발생한 이용자의 손해에 대하여는 책임을 부담하지 아니합니다.</td>
                        </tr>
                        </tbody>
                    </table>
                    
                <h2>제 14 조 (분쟁의 조정 및 기타)</h2>
                    <table>
                        <tbody>
                        <tr>
                            <td className='number-part'>①</td><td>회사는 위치정보와 관련된 분쟁의 해결을 위해 이용자와 성실히 협의합니다.</td>
                        </tr>
                        <tr>
                            <td className='number-part'>②</td><td>전항의 협의에서 분쟁이 해결되지 않은 경우, 회사와 이용자는 위치정보의 보호 및 이용 등에 관한 법률 제28조의 규정에 의해 방송통신위원회에 재정을 신청하거나, 개인정보보호법 제43조의 규정에 의해 개인정보 분쟁조정위원회에 조정을 신청할 수 있습니다.</td>
                        </tr>
                        </tbody>
                    </table>
