...
import com.itda.backend.dto.LocationDTO;
import com.itda.backend.dto.LocationSelectedDTO;
import com.itda.backend.dto.UsersDTO;
...
public interface LocationMapper {
	...
	// public List<LocationDTO> getList(int start, int end, String searchKey, String
	...
	// public List<LocationDTO> getInfo(List<LocationSelectedDTO> userNo) throws
	// Exception;
